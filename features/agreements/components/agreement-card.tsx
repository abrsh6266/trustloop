...
import { ArrowUpRight, CalendarClock, CheckCircle2, XCircle } from "lucide-react";

import type { AgreementSummaryDto } from "@/features/agreements/types";
...
export function AgreementCard({ agreement }: { agreement: AgreementSummaryDto }) {
  ...
  return (
    <motion.article
      ...
      exit={{ opacity: 0, y: 12 }}
      className="group rounded-[28px] border border-white/70 bg-white/95 p-6 shadow-lg shadow-slate-900/5 transition hover:-translate-y-1 hover:shadow-ambient"
    >
