  ...
  return (
    <AuthShell
      ...
      description={
        isLogin
          ...
          : "Start a new Trustloop workspace with Supabase authentication."
      }
      footer={
        isLogin ? (
          <>
    ...
    >
      ...
      >
        ...
        {success ? (
          <div className="rounded-2xl bg-emerald-50 px-4 py-3 text-emerald-700 ring-1 ring-emerald-100">
            {success}
          </div>
        ) : null}
        <Button
